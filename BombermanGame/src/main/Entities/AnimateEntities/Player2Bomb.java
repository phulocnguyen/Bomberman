...
=======
    public static int isBomb2 = 0; // 0 no bomb , 1 has bomb, 2 exploded
>>>>>>> Stashed changes
...
>>>>>>> Stashed changes
    ...
    public static void createEdge() {
        if (Blocked.block_down_bomb(bomb, 0)) {
            edgeDown = new Player2Bomb(bomb.getX() / 32, bomb.getY() / 32 + 1,
        ...
        if (Blocked.block_up_bomb(bomb, 0)) {
            edgeUp = new Player2Bomb(bomb.getX() / 32, bomb.getY() / 32 - 1,
                    Sprite.bombExploded.getFxImage());
            if (bomb_power > 0)
                for (int i = 1; i <= bomb_power; i++)
        ...
        if (Blocked.block_left_bomb(bomb, 0)) {
            edgeLeft = new Player2Bomb(bomb.getX() / 32 - 1, bomb.getY() / 32,
                    Sprite.bombExploded.getFxImage());
            if (bomb_power > 0)
                for (int i = 1; i <= bomb_power; i++)
        ...
        if (Blocked.block_right_bomb(bomb, 0)) {
            edgeRight = new Player2Bomb(bomb.getX() / 32 + 1, bomb.getY() / 32,
                    Sprite.bombExploded.getFxImage());
            if (bomb_power > 0)
                for (int i = 1; i <= bomb_power; i++)
    ...
    public static void createMiddle() {
        ...
        for (int i = 1; i <= bombDown_power; i++) {
            middle = new Player2Bomb(bomb.getX() / 32, bomb.getY() / 32 + i,
                    Sprite.bombExploded.getFxImage());
            list1.add(middle);
        }
        ...
        for (int i = 1; i <= bombLeft_power; i++) {
            middle = new Player2Bomb(bomb.getX() / 32 - i, bomb.getY() / 32,
                    Sprite.bombExploded.getFxImage());
            list.add(middle);
        }
