    ...
    public CreatePvPMap(String level) {
        ...
        try (FileReader inputFile = new FileReader(fileName)) {   
            try( Scanner sc = new Scanner(inputFile)) {                    
                ...
                // PvPGame._level = Integer.parseInt(tokens.nextToken());
                ...
                //System.out.println("2.2");
                    ...
                    //System.out.println("2.3");
                        String lineTile = sc.nextLine();               // Input variable lineTile in string data type.
...
//     public CreatePvPMap(String level) {
//         System.out.println(System.getProperty("user.dir"));
//         File fileName = new File("Bomberman/src/res/levels/PvPMap.txt");                    
//         try (FileReader inputFile = new FileReader(fileName)) {   
